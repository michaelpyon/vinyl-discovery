...
export default function StoreCard({ store, onClick, isActive }) {
  const discogsSearch = `https://www.discogs.com/search/?q=${encodeURIComponent(store.name)}&type=all`
    ...
    >
      ...
      >
        <div className="store-card__header">
          ...
          <span className="store-card__rating" title="Curated editorial listing">
