...
const GLOBE_IMAGE = "/earth-night.jpg"
...
const FALLBACK_CITIES = [
  { lat: 40.7128, lng: -74.006, label: "New York", region: "US East" },
  { lat: 51.5074, lng: -0.1278, label: "London", region: "UK" },
  { lat: 35.6762, lng: 139.6503, label: "Tokyo", region: "Japan" },
  { lat: 52.52, lng: 13.405, label: "Berlin", region: "Germany" },
  { lat: -37.8136, lng: 144.9631, label: "Melbourne", region: "Australia" },
  { lat: 48.8566, lng: 2.3522, label: "Paris", region: "France" },
  { lat: 45.5231, lng: -122.6765, label: "Portland", region: "US West" },
  { lat: 18.012, lng: -76.7936, label: "Kingston", region: "Jamaica" },
  { lat: 6.5244, lng: 3.3792, label: "Lagos", region: "Nigeria" },
  { lat: 36.1627, lng: -86.7816, label: "Nashville", region: "US South" },
  { lat: -23.5505, lng: -46.6333, label: "S\u00e3o Paulo", region: "Brazil" },
  { lat: 37.5665, lng: 126.978, label: "Seoul", region: "South Korea" },
  { lat: 23.1136, lng: -82.3666, label: "Havana", region: "Cuba" },
  { lat: 34.0522, lng: -118.2437, label: "Los Angeles", region: "US West" },
  { lat: 41.8781, lng: -87.6298, label: "Chicago", region: "US Midwest" },
  { lat: 28.6139, lng: 77.209, label: "New Delhi", region: "India" },
]
    ...
    <div className="globe-container globe-fallback">
      <div className="fallback-inner">
        <div className="fallback-header">
          <div className="fallback-index">City index</div>
        ...
        <div className="fallback-grid">
          {FALLBACK_CITIES.map((city) => (
            ...
            >
              ...
              <span className="fallback-city-region">{city.region}</span>
            </button>
          ))}
        </div>
      </div>
...
const Globe = forwardRef(function Globe(
  ...
  const handleGlobeReady = useCallback(() => {
    ...
    globe.pointOfView(
      droppedPin
        ? { lat: droppedPin.lat, lng: droppedPin.lng, altitude: 1.5 }
        : { lat: 30, lng: -20, altitude: 2.2 },
      0
    )
    setGlobeReady(true)
  }, [droppedPin, prefersReducedMotion])
    ...
    <div ref={containerRef} className="globe-container">
      ...
      {!globeReady && dimensions.width > 0 && (
        <div className="globe-loading">
          <div className="globe-loading-spinner" aria-hidden="true" />
